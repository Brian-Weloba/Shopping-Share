...
package com.saturdev.shoppingshare.service;
...
import static com.saturdev.shoppingshare.Models.Constants.SHARED_PREF;
...
import com.saturdev.shoppingshare.BasketActivity;
    ...
    private void handleDataMessage(JSONObject json) {
        ...
        try {
            ...
            if (!NotificationUtils.isAppIsInBackground(getApplicationContext())) {
                ...
                Intent resultIntent = new Intent(getApplicationContext(), BasketActivity.class);
